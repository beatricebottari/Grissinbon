...
public class GrissinbonWhiteClient {
    ...
    public static void main(String[] args) throws UnknownHostException, ClassNotFoundException, IOException {
        ...
        {
            System.out.println("GRISSINBON WHITE CLIENT: INVOCAZIONE ERRATA.");
            System.out.println("Invocazione: GrissinbonWhiteClient [timeout] [ip]");
            System.exit(1);
        }
